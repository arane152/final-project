...
function StateBadge(props){
    ...
    <TotalAcountWrpper><img src="./public/FireState.svg" alt="로고불꽃뱃지용이미지"></img>{props.children}</TotalAcountWrpper> : 
    <>{(type=="Captain") ?  
    <StateCaptainWrpper><img src="./public/FireState.svg" alt="로고불꽃뱃지용이미지"></img>모집자</StateCaptainWrpper> : 
